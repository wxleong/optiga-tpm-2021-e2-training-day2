...
certificateArn=`aws iot create-certificate-from-csr --certificate-signing-request file://out//software.csr --set-as-active --certificate-pem-outfile out/software.crt | jq -r '.certificateArn'`
...
# Read cert
#openssl x509 -in out/software.crt -text -noout
